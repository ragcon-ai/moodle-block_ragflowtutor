...
/**
 * AJAX: re-parse a document in a Tutor block Moodle knowledge base (manage-files only).
 *
 * @package    block_ragflowtutor
 * @copyright  2026 RAGcon GmbH <info@ragcon.ai>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reparse_file extends external_api {
    /**
     * Parameters.
     *
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'docid' => new external_value(PARAM_RAW, 'The RAGflow document id to re-parse.'),
        ]);
    }
    ...
    public static function execute(int $blockinstanceid, string $docid): array {
        ...
        return \block_ragflowtutor\manager::reparse($blockinstanceid, $docid);
    }
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'ok' => new external_value(PARAM_BOOL, 'Whether the re-parse was triggered.'),
